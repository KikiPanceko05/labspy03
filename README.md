...
1. Masukan input nilai n. Anda bisa menggunakan while dan for
   ...
   * Contoh gambar
![input end](https://github.com/kiki05/labspy03kiki05/blob/master/gambar/Latihan1.PNG)
   * Contoh gambar hasil run

![output end](https://github.com/kiki05/labspy03kiki05/blob/master/gambar/RUNLATIHAN1.PNG)
...
# Membuat program untuk menampilkan bilangan terbesar dari n buah data yang diinputkan
  ...
  ## Mencetak bilangan terbesar
    ...
    * Contoh gambar
![input end](https://github.com/kiki05/labspy03kiki/blob/master/gambar/Latihan2.PNG)

 ## Masukan angka 0 untuk berhenti
    * Contoh gambar Run
![output end](https://github.com/kiki05/labspy03kiki/blob/master/gambar/RunLatihan2.PNG)
...
![input end](https://github.com/kiki05/labspy03kiki05/blob/master/gambar/Program1.PNG)

   * Contoh hasil Run

![output end](https://github.com/kiki05/labspy03kiki05/blob/master/gambar/RunProgram1.PNG)
